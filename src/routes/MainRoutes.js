...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/views/online-report/onlineSapStockCntNList',
            element: <AppOnlineSapStockCntNList />
        }, 
        {
            path: '/views/online-report/onlineLiveRatioMgr',
            element: <AppOnlineLiveRatioMgr />
        },         
